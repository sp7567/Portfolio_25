...
}, 3200); // 3.2 second display time to match animation
...
// Typed.js effect for the typing text
var typed = new Typed(".typing-text", {
    strings: ["Full Stack Developer", "Software Developer", "Cloud & DevOps Enthusiast", "Robotics Enthusiast"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 1000,
...
if (themeToggle) {
  const themeToggleIcon = themeToggle.querySelector('i');
  if (themeToggleIcon) themeToggleIcon.style.pointerEvents = 'none'; // Ensure clicks go to button
